...
module.exports = [
  ...
  },
  {
    ...
    sections: [
      ['Ferramenta disponível', r => `<div class="card-grid"><a class="topic-card" href="${r}ferramentas/gestao-do-tempo/"><span class="topic-card__label">Disponível agora</span><h3>Tempo 10X</h3><p>Cadastre tarefas, use o cronômetro em tempo real, filtre períodos, acompanhe gráficos e exporte relatórios.</p></a><a class="topic-card" href="${r}ferramentas/matriz-eisenhower/"><span class="topic-card__label">Disponível agora</span><h3>Matriz de Eisenhower Online</h3><p>Organize tarefas por urgência e importância.</p></a></div><p>O Tempo 10X salva os dados no armazenamento local do navegador. Ele não exige conta e não sincroniza automaticamente entre dispositivos; o backup JSON permite transferência manual.</p>`],
      ['Critérios para novas ferramentas', () => `<p>Uma nova ferramenta só entra no portal quando resolve um fluxo completo, funciona em celular e teclado, explica limites de uso e possui validação automatizada. O roadmap considera Pomodoro, checklist 5S, diagnóstico 5S, checklist ambiental e 5W2H. Essas URLs não serão publicadas antes de haver utilidade real.</p>`],
